...
userNumber = 25
offsetHours = 5
affectFileName = "24 Justin Morning-process.csv"
robotFileName = "24_Justin_Flow_2016-02-25_12-47-10.csv"
...
def plotAffect(affectCSVList, robotCSVList, userNumber = 1, interactionType = "Morning"):
    ...
    AvgV = [1.11764705882] * len(MVs)
    AvgA = [0.0392156862745] * len(MAs)
