...
userNumber = 25
offsetHours = 5
affectFileName = "17 Yugong End of day-process.csv"
robotFileName = "17_Yugong_Flow_2016-02-24_16-46-28.csv"
...
def plotAffect(affectCSVList, robotCSVList, userNumber = 1, interactionType = "Morning"):
    ...
    AvgV = [0.0731707317073] * len(MVs)
    AvgA = [0.939024390244] * len(MAs)
