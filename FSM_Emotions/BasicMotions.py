...
### ================================================================================== davids stuff
    ...
    def fear2Emotion(self): # hand to face
        ...
        names.append("LElbowYaw")
        times.append([0.8, 1.6])
        keys.append([-1.20577, -1.22111])

        names.append("LHand")
        times.append([0.8, 1.6])
        keys.append([0.2944, 0.2884])

        names.append("LHipPitch")
        times.append([0.8, 1.6])
        keys.append([0.135034, 0.138102])

        names.append("LHipRoll")
        times.append([0.8, 1.6])
        keys.append([0.0982179, 0.105888])

        names.append("LHipYawPitch")
        times.append([0.8, 1.6])
        keys.append([-0.164096, -0.161028])

        names.append("LKneePitch")
        times.append([0.8, 1.6])
        keys.append([-0.0828778, -0.0874801])

        names.append("LShoulderPitch")
        times.append([0.8, 1.6])
        keys.append([1.45879, 1.43271])

        names.append("LShoulderRoll")
        times.append([0.8, 1.6])
        keys.append([0.1733, 0.202446])

        names.append("LWristYaw")
        times.append([0.8, 1.6])
        keys.append([0.0873961, 0.076658])

        names.append("RAnklePitch")
        times.append([0.8, 1.6])
        keys.append([0.0890141, 0.101286])

        names.append("RAnkleRoll")
        times.append([0.8, 1.6])
        keys.append([0.12583, 0.128898])

        names.append("RElbowRoll")
        times.append([0.8, 1.6])
        keys.append([0.438765, 1.11066])
        ...
        names.append("RHand")
        times.append([0.8, 1.6])
        keys.append([0.2888, 0.9848])

        names.append("RHipPitch")
        times.append([0.8, 1.6])
        keys.append([0.133416, 0.13495])
        ...
        names.append("RKneePitch")
        times.append([0.8, 1.6])
        keys.append([-0.0889301, -0.0858622])
