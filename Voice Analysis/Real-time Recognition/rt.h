...
// the following #define is related to use in Visual C++ 2005 Express Edition - it stops vsiaul C++ putting out errors
// about deprecated functions like strcpy() which it believes are unsafe (but work anyway if you know what you are doing
