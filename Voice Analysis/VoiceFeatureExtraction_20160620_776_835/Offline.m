...
% Ouput settings
f = fopen('offline_results/data_everyone3_20ms_window_20ms_step.csv','w');
labelCol = ['Name,Zcr,Energy,SpecCentroSpread,SpecEntropy,SpecFlux,SpecRolloff,' ...
    'MFCC1,MFCC2,MFCC3,MFCC4,MFCC5,MFCC6,MFCC7,MFCC8,MFCC9,MFCC10,' ... 
    'MFCC11,MFCC12,MFCC13,MFCC14,MFCC15,MFCC16,MFCC17,MFCC18,' ...
    'F0,CV1,CV2,CV3,CV4,CV5,CV6,CV7,CV8,CV9,CV10,CV11,CV12,' ...    
    'LPC1,LPC2,LPC3,LPC4,LPC5,LPC6,LPC7,' ...
    'LPC8,LPC9,LPC10,LPC11,LPC12,LPC13,LPC14\n'];
fprintf(f,labelCol);
...
%         plot(t, segment, t, clean);
        ...
        features = normalize_ft_matrix(features);
        features = features(:,1:end-1);
        allOneString = sprintf('%.7f,' , features);
